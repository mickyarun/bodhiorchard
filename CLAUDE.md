...
This project is indexed by GitNexus as **flowdev** (4248 symbols, 10323 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/flowdev/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/flowdev/context` | Codebase overview, check index freshness |
| `gitnexus://repo/flowdev/clusters` | All functional areas |
| `gitnexus://repo/flowdev/processes` | All execution flows |
| `gitnexus://repo/flowdev/process/{name}` | Step-by-step execution trace |
