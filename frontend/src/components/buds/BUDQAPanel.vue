...
/* Markdown rendering for test plan + execution plan now lives in
   ``assets/styles/markdown-body.scss`` and applies via the global
   ``.markdown-body`` class — kept in sync with the Learning recap
   panel so both surfaces look identical. */
</style>
