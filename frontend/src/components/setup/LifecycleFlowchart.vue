...
const nodes: PhaseNode[] = [
  ...
  },
  {
    ...
    centerDesc: 'Full spec, tech plan, test plan, and acceptance criteria generated',
    agentNames: ['BUD Agent'],
  },
  {
    id: 'design', icon: 'mdi-palette-outline', label: 'Design',
    agent: 'Design Agent', color: 'primary',
    centerDesc: 'UI/UX scoping with component breakdowns and interaction specs',
  ...
  },
  {
    ...
    centerDesc: 'Auto-generated implementation plan with gated approval before development',
  ...
  },
  {
    ...
    agentNames: ['Tech Plan Agent', 'Standup Agent'],
  },
  {
