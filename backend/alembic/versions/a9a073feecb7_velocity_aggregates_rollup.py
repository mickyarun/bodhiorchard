...
down_revision: Union[str, None] = 'af5af83d4327'
...
def upgrade() -> None:
    ...
    op.create_table('velocity_aggregates',
    ...
    sa.Column('sample_window', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=False),
    sa.Column('contributing_bud_ids', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=False),
    ...
    sa.Column('running_mean', sa.Numeric(precision=10, scale=4), server_default='0', nullable=False),
    sa.Column('running_m2', sa.Numeric(precision=12, scale=4), server_default='0', nullable=False),
    ...
    op.create_index('ix_velocity_agg_lookup', 'velocity_aggregates', ['org_id', 'complexity'], unique=False)
    op.create_index(op.f('ix_velocity_aggregates_org_id'), 'velocity_aggregates', ['org_id'], unique=False)
