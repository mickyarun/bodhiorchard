...
def build_estimation_prompt(
    ...
    return (
        ...
        "based on the feature's actual substance — what the work really involves, "
        "not how many files or repos it touches.\n\n"
        f"As a hint, a length/repo heuristic guessed {complexity}/5 from BUD signals, "
        "but it cannot read the spec: a change spanning several repos may still be "
        "trivial (a shared version bump), and a short spec may hide deep work. Rate "
        "it yourself; we keep your rating within ±1 of the hint.\n"
